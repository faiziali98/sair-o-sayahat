$(document).ready(function() {
	...
	var mybot = '<div class="chatCont" id="chatCont">'+
								'<div class="bot_profile">'+
									'<i class="fas fa-envelope" style="font-size:62px;color:#5555f3" aria-hidden="true"></i>'+
									'<div class="close1" style="float:right;">'+
										'<i class="fa fa-times" style="margin-top: 43px;color: black;" aria-hidden="true"></i>'+
									'</div>'+
								'</div><!--bot_profile end-->'+
							...
							'<div class="profile_div">'+
								'<div class="row">'+
									'<div class="col-hgt">'+
										'<i class="fas fa-envelope" style="font-size:62px;color:#5555f3"></i>'+
									'</div><!--col-hgt end-->'+
									'<div class="col-hgt">'+
										'<div class="chat-txt">'+
											'Chat with us now!'+
